...
#ifndef MSG_LEGROBOT__MSG__DETAIL__INFO_LEG_STATE__TRAITS_HPP_
#define MSG_LEGROBOT__MSG__DETAIL__INFO_LEG_STATE__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  // member: pos_body
  {
    if (msg.pos_body.size() == 0) {
      out << "pos_body: []";
    } else {
      out << "pos_body: [";
      size_t pending_items = msg.pos_body.size();
      for (auto item : msg.pos_body) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  // member: acc_imu
  {
    if (msg.acc_imu.size() == 0) {
      out << "acc_imu: []";
    } else {
      out << "acc_imu: [";
      size_t pending_items = msg.acc_imu.size();
      for (auto item : msg.acc_imu) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  // member: gyro_imu
  {
    if (msg.gyro_imu.size() == 0) {
      out << "gyro_imu: []";
    } else {
      out << "gyro_imu: [";
      size_t pending_items = msg.gyro_imu.size();
      for (auto item : msg.gyro_imu) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
...
inline std::string to_yaml(const InfoLegState & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const msg_legrobot::msg::InfoLegState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const msg_legrobot::msg::InfoLegState & msg)
{
  return msg_legrobot::msg::to_yaml(msg);
}

template<>
inline const char * data_type<msg_legrobot::msg::InfoLegState>()
{
  return "msg_legrobot::msg::InfoLegState";
}

template<>
inline const char * name<msg_legrobot::msg::InfoLegState>()
{
  return "msg_legrobot/msg/InfoLegState";
}

template<>
struct has_fixed_size<msg_legrobot::msg::InfoLegState>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<msg_legrobot::msg::InfoLegState>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<msg_legrobot::msg::InfoLegState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MSG_LEGROBOT__MSG__DETAIL__INFO_LEG_STATE__TRAITS_HPP_
