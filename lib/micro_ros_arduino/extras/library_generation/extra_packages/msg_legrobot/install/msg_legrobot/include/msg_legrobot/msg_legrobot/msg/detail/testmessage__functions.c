...
msg_legrobot__msg__Testmessage__create()
{
  ...
  msg_legrobot__msg__Testmessage * msg = (msg_legrobot__msg__Testmessage *)allocator.allocate(sizeof(msg_legrobot__msg__Testmessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(msg_legrobot__msg__Testmessage));
  bool success = msg_legrobot__msg__Testmessage__init(msg);
  if (!success) {
...
msg_legrobot__msg__Testmessage__destroy(msg_legrobot__msg__Testmessage * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    msg_legrobot__msg__Testmessage__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
msg_legrobot__msg__Testmessage__Sequence__init(msg_legrobot__msg__Testmessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msg_legrobot__msg__Testmessage * data = NULL;

  if (size) {
    data = (msg_legrobot__msg__Testmessage *)allocator.zero_allocate(size, sizeof(msg_legrobot__msg__Testmessage), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = msg_legrobot__msg__Testmessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        msg_legrobot__msg__Testmessage__fini(&data[i - 1]);
      }
...
msg_legrobot__msg__Testmessage__Sequence__fini(msg_legrobot__msg__Testmessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      msg_legrobot__msg__Testmessage__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  msg_legrobot__msg__Testmessage__Sequence * array = (msg_legrobot__msg__Testmessage__Sequence *)allocator.allocate(sizeof(msg_legrobot__msg__Testmessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = msg_legrobot__msg__Testmessage__Sequence__init(array, size);
  if (!success) {
...
msg_legrobot__msg__Testmessage__Sequence__destroy(msg_legrobot__msg__Testmessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    msg_legrobot__msg__Testmessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
msg_legrobot__msg__Testmessage__Sequence__are_equal(const msg_legrobot__msg__Testmessage__Sequence * lhs, const msg_legrobot__msg__Testmessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!msg_legrobot__msg__Testmessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  msg_legrobot__msg__Testmessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(msg_legrobot__msg__Testmessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    msg_legrobot__msg__Testmessage * data =
      (msg_legrobot__msg__Testmessage *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!msg_legrobot__msg__Testmessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          msg_legrobot__msg__Testmessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!msg_legrobot__msg__Testmessage__copy(
